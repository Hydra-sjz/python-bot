...
BOT_TOKEN = "5764337430:AAErAYClzy1xB_iH1Up2mN2kEIKGjNqymRY"
PAYMENT_CHANNEL = "@jndndjdnkkd" #add payment channel here including the '@' sign
OWNER_ID = 5422115985 #write owner's user id here.. get it from @MissRose_Bot by /id
CHANNELS = ["@jndndjdnkkd"] #add channels to be checked here in the format - ["Channel 1", "Channel 2"] 
